...
impl PakFileType {
    fn starts_with(&self, buf: &[u8]) -> bool {
        buf.get(self.offset..).unwrap_or(b"").starts_with(self.identifier)
    }
}
...
pub static PAK_FILE_TYPES: [PakFileType; 19] = [
    PakFileType {
        ext_name: ".png",
