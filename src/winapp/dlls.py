...
gdi32.GetEnhMetaFileBits.argtypes = (HENHMETAFILE, UINT, LPBYTE)
gdi32.GetEnhMetaFileBits.restype = UINT
gdi32.GetMetaFileBitsEx.argtypes = (HMETAFILE, UINT, LPVOID)
gdi32.GetMetaFileBitsEx.restype = UINT
...
ole32.OleGetClipboard.argtypes = (LPVOID,)
ole32.OleInitialize.argtypes = (LPVOID,)
ole32.RegisterDragDrop.argtypes = (HWND, LPVOID)
